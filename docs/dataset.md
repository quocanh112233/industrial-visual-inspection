...
*Sinh tự động bởi `ivid.data.stats` lúc 2026-09-09T03:27:02+00:00*
...
|---|---:|---:|---:|---:|---:|
| `crazing` | 481 | 100 | 108 | **689** | 16.4% |
| `inclusion` | 716 | 158 | 137 | **1011** | 24.1% |
| `patches` | 629 | 122 | 130 | **881** | 21.0% |
...
- **Mất cân bằng lớp: 2.34×** giữa lớp nhiều nhất (`inclusion`, 1011 bbox) và ít nhất (`pitted_surface`, 432 bbox).
